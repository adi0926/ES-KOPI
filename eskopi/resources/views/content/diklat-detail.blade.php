                                                                        ...
                                                                        <div class="course-item-meta">
                                                                            <span class="item-meta duration">
                                                                                ...
                                                                                @elseif($konten->id_tipe_konten == 0)
                                                                                    '--:--:--'
                                                                                @elseif($konten->id_tipe_konten == 4)
                                                                                    {{ $konten->materiVclass->durasi ? gmdate("H:i:s", $konten->materiVclass->durasi * 60) : '--:--:--' }}
                                                                                @elseif($konten->id_tipe_konten == 20)
                            ...
                            <ul class="list-wrap">
                                ...
                                <li>
                                    <img src="{{ asset('frontend/img/icons/course_icon04.svg') }}" alt="img"
                                        class="injectable">
                                    {{ __('Soal Test') }}
                                    <span> {{ $diklat->countSoal() }} Test </span>
                                </li>
                                <li>
                        ...
                        <div class="courses__details-enroll">
                            ...
                            @if ($diklat->registration_status)
                                ...
                                @elseif ($diklat->registration_status->status == 1)
                                    <a href="{{ route('peserta.mulaidiklat', $id_diklat)}}" class="btn btn-two arrow-btn add-to-cart">
