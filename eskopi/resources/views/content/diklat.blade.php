                            ...
                            @foreach($categories as $category)
                                <li>
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" value="" id="cat_{{ $category->id_kategori }}">
            ...
            <div class="col-xl-9 col-lg-8">
                    ...
                    <div class="row align-items-center">
                        <div class="col-md-5">
                            <div class="courses-top-left">
                                <p>Total {{ $alldiklat->count() }} Diklat (Semua)</p>
                            </div>
                        </div>
                        <div class="col-md-7">
                ...
                <div class="tab-content" id="myTabContent">
                    <div class="preloader-two d-none">
                        <div class="loader-icon-two"><img src="{{ asset('frontend/img/logo/preloader.svg') }}" alt="Preloader"></div>
                    </div>
                            ...
                            <div class="col">
                                <div class="courses__item shine__animate-item">
                                    ...
                                    <div class="courses__item-content">
                                        ...
                                        <h5 class="title">
                                            <a href="{{ route('diklatdetail', $id_diklat) }}">{{ \Illuminate\Support\Str::limit($diklat->nama_diklat, 50, '...') }}</a>
                                        </h5>
