...
<head>
    ...
    <style>
        ...
        /* Scoped CSS for the test completion page */
        .test-completion {
            
        }

        .test-completion .completion-header {
            margin-bottom: 20px;
        }

        .test-completion .trophy-icon {
            width: 150px;
            height: 150px;
        }

        .test-completion .completion-title {
            font-size: 20px;
            font-weight: bold;
            color: #263D93;
            margin-top: 10px;
        ...
        .test-completion .completion-details {
            background-color: white;
            padding: 15px;
            border-radius: 10px;
            margin-bottom: 20px;
        ...
        .test-completion .details-row span {
            display: block;
        }

        .test-completion .score {
            font-size: 24px; /* Increase the font size for the score */
            font-weight: bold;
        }
