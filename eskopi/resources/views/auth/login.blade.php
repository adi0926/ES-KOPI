    ...
    <section class="features__area_auth">
        <div class="container">
            <div class="row justify-content-start">
                <span style="font-size: 30px; color: #FFFFFF;">Masuk</span>
            </div>
        </div>
    </section>
                ...
                <div class="row align-items-center justify-content-center">
                    <div class="col-lg-5 col-md-6">
                        <div class="about__images_auth">
                            <img src="{{ asset('frontend/img/logo/image_login.png') }}" alt="img" class="main-img" style="width: 295px; border-radius: 12px; box-shadow: 0 4px 8px rgba(0, 0, 0, 0.1);">
                        </div>
                    </div>
                            ...
                            <div class="regis-rectangle-wrap">
                                ...
                                <div class="button-group">
                                    ...
                                    <div id="asn-buttons" style="display:none;">
                                        ...
                                        <a href="masuknon" class="btn custom-btn">{{ __('NON BKPM') }}</a>
                                    </div>
                                    <a href="masuknon" class="btn btn-border" style="margin-top:20px;">{{ __('NON ASN') }}</a>
                                </div>
                            </div>
                        </div>
                    </div>
