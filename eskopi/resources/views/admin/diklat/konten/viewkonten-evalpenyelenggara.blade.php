...
@section('title')
    <title>{{ __('Konten Evaluasi Penyelenggara') }}</title>
@endsection
    ...
    <div class="main-content">
        <section class="section">
            <div class="section-header">
                ...
                <h1>{{ __('Konten Evaluasi Penyelenggara') }}</h1>
                <div class="section-header-breadcrumb">
                    ...
                    <div class="breadcrumb-item">{{ __('Konten Evaluasi Penyelenggara') }}</div>
                </div>
            </div>
                        ...
                        <div class="card">
                            <div class="card-header d-flex justify-content-between">
                                ...
                                <div class="d-flex">
                                    ...
                                    <div>
                                        <a href="{{ route('admin.salinkonten-soal', ['jeniskonten' => 'evalpenyelenggara', 'id' => $id_materi_eval]) }}" class="btn btn-primary mr-2">
                            ...
                            @else
                                <div class="table-responsive">
                                    <table class="stripe row-border order-column nowrap" id="tableListKontenEvaluasiPenyelenggara">
                                        <thead>
                                            <tr>
                                                <th width="2%"></th>
                                                <th width="2%">{{ __('No') }}</th>
...
@push('js')
    <script>
        ...
        new DataTable('#tableListKontenEvaluasiPenyelenggara', {
            columnDefs: [
                {
                    orderable: false,
