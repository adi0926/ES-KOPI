...
@section('title')
    <title>{{ __('Edit Konten Materi Soal') }}</title>
@endsection
...
<div class="main-content" style="min-height: 606px;">
        <section class="section">
            <div class="section-header">
                ...
                <h1>{{ __('Edit Konten Materi Soal') }}</h1>
                @php
                ...
                <div class="section-header-breadcrumb">
                    ...
                    <div class="breadcrumb-item">{{ __('Edit Konten Materi Soal') }}</div>
                </div>
            </div>
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header d-flex justify-content-between">
                                <h4>Edit Konten Materi Soal</h4>
                                <div>
                                    <a href="{{ route('admin.viewkonten-soal', $id_materi_soal) }}" class="btn btn-primary"><i class="fa fa-arrow-left"></i> Kembali</a>
                                </div>
                            </div>
                            <div class="card-body">
                                <form action="{{ route('admin.updatekonten-soal') }}" method="POST" enctype="multipart/form-data">
                                    @csrf                                 
                                    <div class="row">
                                        ...
                                        <div class="form-group col-12">
                                            ...
                                            <div class="d-flex align-items-center">
                                                <input type="text" id="optE" class="form-control mr-2" style="flex-grow: 1;" name="optE" value="{{ $Soal->pilihan_e }}" {{ is_null($Soal->pilihan_e) ? 'disabled' : '' }}>
