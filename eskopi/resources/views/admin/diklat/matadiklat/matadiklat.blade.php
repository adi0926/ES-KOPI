                                    ...
                                    <div class="card-body">
                                        <form action="{{ route('admin.matadiklat-store') }}" method="POST" enctype="multipart/form-data">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select class="form-control" name="mata_diklat" id="mata_diklat">
                                                    <option value="">{{ __('Pilih') }}</option>
                                                    @foreach($masterMataDiklat as $matadiklat)
                                                        <option value="{{ $matadiklat->id_master_mata_diklat }}">{{ $matadiklat->mata_diklat }}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                    ...
                                    <div class="card-body">
                                        <form id="editMataDiklatForm" method="POST" enctype="multipart/form-data">
                                            ...
                                            <div class="form-group">
                                                ...
                                                @if ($hasZeroTipeAngkatan)
                                                    <input type="text" class="form-control" value="{{ $diklatAngkatan->firstWhere('tipe_angkatan', 0)->nama_angkatan }}" readonly>
                                                    <input type="hidden" name="angkatan" id="edit_angkatan" value="{{ $diklatAngkatan->firstWhere('tipe_angkatan', 0)->id_diklat_angkatan }}">
                                                @else
                                                    ...
                                                    <div class="card-body">
                                                        <form action="{{ route('admin.kontendiklat-store') }}" method="POST" enctype="multipart/form-data">
                                                            ...
                                                            <div id="form-video" style="display: none;">
                                                                ...
                                                                <div class="form-group">
                                                                    <label for="url_video">ID Video</label>
                                                                    <input type="text" class="form-control" name="url_video" id="url_video" placeholder="Masukkan ID Video">
                                                                </div>
                                                                <div class="form-group">
                                                            ...
                                                            <div id="form-pdf" style="display: none;">
                                                                ...
                                                                <div class="form-group">
                                                                    <label for="url_pdf">FILE PDF</label>
                                                                    <input type="file" id="url_pdf" name="url_pdf" value="" placeholder="" class="form-control"> 
                                                            ...
                                                            <div id="form-lain" style="display: none;">
                                                                <div class="form-group">
                                                                    ...
                                                                    <input type="text" class="form-control" name="judul_konten" id="judul_konten" placeholder="Masukkan Judul Konten">
                                                                </div>
                                                            </div>
                                                            
                                                            <!-- Materi Virtual Class Form -->
                                                            <div id="form-vclass" style="display: none;">
                                                                <div class="form-group">
                                                                    <label for="judul_vclass">Judul Virtual Class</label>
                                                                    <input type="text" class="form-control" name="judul_vclass" id="judul_vclass" placeholder="Masukkan Judul Virtual Class">
                                                                </div>
                                                                <div class="form-group">
                                                                    <label for="url_vclass">URL Virtual Class</label>
                                                                    <input type="text" class="form-control" name="url_vclass" id="url_vclass" placeholder="Masukkan URL Virtual Class">
                                                                </div>
                                                                <div class="form-group">
                                                                    <label for="durasi_vclass">Durasi (dalam menit)</label>
                                                                    <input type="number" class="form-control" name="durasi_vclass" id="durasi_vclass" placeholder="Masukkan Durasi Virtual Class">
                                                                </div>
                                                            </div>

                                                            <!-- Materi Evaluasi Penyelenggara -->
                                                            <div id="form-evalpenyelenggara" style="display: none;">
                                                                <div class="form-group">
                                                                    <label for="judul_eval_a">Judul Evaluasi</label>
                                                                    <input type="text" class="form-control" name="judul_eval_a" id="judul_eval_a" placeholder="Masukkan Judul Evaluasi Penyelenggara">
                                                                </div>
                                                                <div class="form-group">
                                                                    <label for="penyelenggara">Penyelenggara</label>
                                                                    <input type="text" class="form-control" name="penyelenggara" id="penyelenggara" placeholder="Masukkan Nama Penyelenggara">
                                                                </div>
                                                                <div class="form-group">
                                                                    <label for="durasi_eval_a">Durasi (dalam menit)</label>
                                                                    <input type="number" class="form-control" name="durasi_eval_a" id="durasi_eval_a" placeholder="Masukkan Durasi Evaluasi">
                                                                </div>
                                                            </div>

                                                            <!-- Materi Evaluasi Pengajar -->
                                                            <div id="form-evalpengajar" style="display: none;">
                                                                <div class="form-group">
                                                                    <label for="judul_eval_b">Judul Evaluasi</label>
                                                                    <input type="text" class="form-control" name="judul_eval_b" id="judul_eval_b" placeholder="Masukkan Judul Evaluasi Pengajar">
                                                                </div>
                                                                <div class="form-group">
                                                                    <label for="pengajar">Pengajar</label>
                                                                    <input type="text" class="form-control" name="pengajar" id="pengajar" placeholder="Masukkan Nama Pengajar">
                                                                </div>
                                                                <div class="form-group">
                                                                    <label for="durasi_eval_b">Durasi (dalam menit)</label>
                                                                    <input type="number" class="form-control" name="durasi_eval_b" id="durasi_eval_b" placeholder="Masukkan Durasi Evaluasi">
                                                                </div>
                                                            </div>
    ...
    <script>
        ...
        document.querySelectorAll('.showTambahKontenFormBtn').forEach(button => {
            button.addEventListener('click', () => {
                ...
                tambahKontenFormSection.scrollIntoView({
                    behavior: 'smooth',
                    block: 'start'
                });
            });
        ...
        document.getElementById("tipe_konten").addEventListener("change", function() {
            ...
            document.getElementById("form-lain").style.display = (value === "0") ? "block" : "none";
            ...
            document.getElementById("form-soal").style.display = (value === "9") ? "block" : "none";
            document.getElementById("form-vclass").style.display = (value === "4") ? "block" : "none";
            document.getElementById("form-evalpenyelenggara").style.display = (value === "20") ? "block" : "none";
            document.getElementById("form-evalpengajar").style.display = (value === "21") ? "block" : "none";
        });
        ...
        document.querySelectorAll('.showListKontenBtn').forEach(button => {
            button.addEventListener('click', () => {
                ...
                listKontenSection.scrollIntoView({
                    behavior: 'smooth',
                    block: 'start'
                });
