                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header d-flex justify-content-between">
                                <h4>Ubah User Level</h4>
                                <div>
                                    <a href="{{ route('admin.user-level') }}" class="btn btn-primary"><i class="fa fa-arrow-left"></i> Kembali</a>
                                </div>
                            </div>
                            <div class="card-body">
                                <form action="{{ route('admin.user-level-update') }}" method="POST" enctype="multipart/form-data">
                                    @csrf     
                                    <div class="row">
                                    ...
                                    <div class="row">
                                        <div class="col-12">
                                        <input type="hidden" id="id_mata_diklat" class="form-control" name="id_mata_diklat" value="{{ $userLevel->id_mata_diklat }}">
