        ...
        <section class="section">
            <div class="section-header">
                ...
                <div class="section-header-breadcrumb">
                    ...
                    <div class="breadcrumb-item">{{ __('Tambah Mata Diklat') }}</div>
                </div>
            </div>
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header d-flex justify-content-between">
                                <h4>Tambah Mata Diklat</h4>
                                <div>
                                    <a href="{{ route('admin.master-matadiklat') }}" class="btn btn-primary"><i class="fa fa-arrow-left"></i> Kembali</a>
                                </div>
                            </div>
                            <div class="card-body">
                                <form action="{{ route('admin.master-matadiklat-store') }}" method="POST" enctype="multipart/form-data">
                                    @csrf
                                    <div class="row">
