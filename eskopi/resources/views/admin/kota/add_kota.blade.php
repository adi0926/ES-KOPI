        ...
        <section class="section">
            <div class="section-header">
                ...
                <div class="section-header-breadcrumb">
                    ...
                    <div class="breadcrumb-item">{{ __('Tambah Kota') }}</div>
                </div>
            </div>
                                ...
                                <form action="{{ route('admin.kota-store') }}" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group col-12">
                                            <div class="form-group">
                                                <label for="provinsi">Level<span class="text-danger">*</span></label>
                                    ...
                                    <div class="row">
                                        <div class="form-group col-12">
                                            ...
                                            <input type="text" id="idkota" class="form-control" name="idkota">
                                        </div>
                                    </div>                              
                                    <div class="row">
                                        <div class="form-group col-12">
