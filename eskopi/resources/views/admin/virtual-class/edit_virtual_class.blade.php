        ...
        <section class="section">
            <div class="section-header">
                ...
                <div class="section-header-breadcrumb">
                    ...
                    <div class="breadcrumb-item">{{ __('Ubah Virtual Class') }}</div>
                </div>
            </div>
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header d-flex justify-content-between">
                                <h4>Ubah Virtual Class</h4>
                                <div>
                                    <a href="{{ route('admin.virtual-class') }}" class="btn btn-primary"><i class="fa fa-arrow-left"></i> Kembali</a>
                                </div>
                            </div>
                            <div class="card-body">
                                <form action="{{ route('admin.virtual-class-update') }}" method="POST" enctype="multipart/form-data">
                                    @csrf     
                                    <div class="row">
                                    ...
                                    <div class="row">
                                        <div class="col-12">
                                        <input type="hidden" id="id_mata_diklat" class="form-control" name="id_mata_diklat" value="{{ $virtualClass->id_mata_diklat }}">
