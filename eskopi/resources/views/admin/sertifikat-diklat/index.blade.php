        ...
        <section class="section">
            <div class="section-header">
                ...
                <div class="section-header-breadcrumb">
                    ...
                    <div class="breadcrumb-item">{{ __('Sertifikat') }}</div>
                </div>
            </div>
                ...
                <div class="row mt-4">
                    <div class="col-lg-4">
                        <div class="alert alert-primary d-flex align-items-center" role="alert">
                            ...
                            <div class="ml-3">
                                {{ __('Ada banyak tag berguna yang dapat Anda gunakan, seperti [nama_siswa], [nama_diklat], [angkatan], [tanggal]. Jangan ragu untuk menggunakannya di mana saja dalam judul, subjudul, atau deskripsi Anda') }}
                            </div>
                        </div>
                        <div class="card">
                            <div class="card-header d-flex justify-content-between">
                                <h4>{{ __(' Detail Sertifikat') }}</h4>
                            </div>
                            <div class="card-body">
                                <form action="{{ route('admin.certificate-builder.update', 1) }}" method="POST"
                                    ...
                                    <div class="form-group">
                                        <label for="">{{ __('Gambar Latar') }} <code>( 930px * 600px )
                                                *</code></label>
                                    ...
                                    <div class="form-group">
                                        <label for="">{{ __('No Serifikat') }}</label>
                                        <input type="no_certificate" class="form-control" name="no_certificate"
                                            value="{{ $certificate->no_certificate }}">
                                    </div>
                                    ...
                                    <div class="form-group">
                                        <label for="">{{ __('Sub Judul') }}</label>
                                        <input type="text" class="form-control" name="sub_title"
                                            value="{{ $certificate->sub_title }}">
                                    </div>
                                    <div class="form-group">
                                        <label for="">{{ __('Deskripsi') }}</label>
                                        <textarea id="" class="form-control hight-200" name="description">{!! ($certificate->description) !!}</textarea>
                                    </div>
                                    <div class="form-group">
                                        <label for="">{{ __('Nama Penanda Tangan') }}</label>
                                        <input type="text" class="form-control" name="signature_name"
                                            value="{{ $certificate->signature_name }}">
                                    </div>
                                    <div class="form-group">
                                        <label for="">{{ __('Tanda Tangan') }}
                                            <code>{{ __('Ukuran: (120px * 40px)') }}</code></label>
                                                *</code></label>
                    ...
                    <div class="col-lg-8">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <p class="text-center text-danger">{{ __('Ukuran Gambar Latar Sebaiknya ( 930px * 600px )') }}
                                </p>
                                        ...
                                        <table class="table">
                                            <div class="certificate-body">
                                                @if ($certificate->title)
                                                    <div id="no_certificate" class="draggable-element">{{ $certificate->no_certificate }}
                                                    </div>
                                                @endif
                                                @if ($certificate->title)
                                                ...
                                                @if ($certificate->description)
                                                    <div id="description" class="draggable-element">{!! nl2br($certificate->description) !!}
                                                    </div>
                                                @endif
                                                ...
                                                @if ($certificate->signature_name)
                                                    <div id="signature_name" class="draggable-element">{{ $certificate->signature_name }}
                                                    </div>
                                                @endif
                                            </div>
                                        </table>
