...
$(document).ready(function () {
    ...
    $(".lesson-item").on("click", function () {
                    ...
                    <div class="resource-file">
                        <div class="file-info">
                            <div class="text-center">
                                ...
                                <a href="#" class="btn btn-primary" id="start-pretest" data-tipesoal="${tipeSoal}" data-matadiklat=${mataDiklat} data-idkonten="${id_konten}" data-durasipengerjaan="${durasiSoal}">Mulai Pre Test</a>
                            </div>
                        </div>
                    </div>`;
                } else {
                            ...
                            <div class="text-center">
                                <div class="test-completion">
                                    <div class="completion-header">
                                        ...
                                        <h2 class="completion-title">Selamat Anda telah menyelesaikan Pre Test Diklat ini.</br> Nilai anda sudah tersimpan.</h2>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="resource-file">
                        <div class="file-info">
                            <div class="text-center">
                                ...
                                <p>Jumlah soal : ${jumlahSoal} Soal</p>
                                <p>Durasi Pengerjaan : ${durasiSoal} Menit</p>
                                <a href="#" class="btn btn-primary" id="start-pretest" data-tipesoal="${tipeSoal}" data-matadiklat=${mataDiklat} data-idkonten="${id_konten}" data-durasipengerjaan="${durasiSoal}">Mulai Post Test</a>
                            </div>
                        </div>
                    </div>`;
                } else {
                        ...
                        <div class="file-info">
                            <div class="text-center">
                                <div class="test-completion">
                                    <div class="completion-header">
                                        <img src="/uploads/website-images/completetest.jpg" alt="Test Image" class="trophy-icon">
                                        <h2 class="completion-title">Selamat Anda telah menyelesaikan Post Test Diklat ini.</br> Nilai anda sudah tersimpan.</h2>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="resource-file">
                        <div class="file-info">
                            <div class="text-center">
                                ...
                                <p>Jumlah soal : ${jumlahSoal} Soal</p>
                                <p>Durasi Pengerjaan : ${durasiSoal} Menit</p>
                                <a href="#" class="btn btn-primary" id="start-pretest" data-tipesoal="${tipeSoal}" data-matadiklat=${mataDiklat} data-idkonten="${id_konten}" data-durasipengerjaan="${durasiSoal}">Mulai Ujian</a>
                            </div>
                        </div>
                    </div>`;
                } else {
                        ...
                        <div class="file-info">
                            <div class="text-center">
                                <div class="test-completion">
                                    <div class="completion-header">
                                        <img src="/uploads/website-images/completetest.jpg" alt="Test Image" class="trophy-icon">
                                        <h2 class="completion-title">Selamat Anda telah menyelesaikan Soal Ujian Materi Diklat ${mataDiklat}.</br> Nilai anda sudah tersimpan.</h2>
                                    </div>
                                </div>
                            </div>
                        </div>
        ...
        } else if (tipekonten == "evaluasiA") {
            var statusPengerjaan = $(this).attr("data-status");
            var namaPenyelenggara = $(this).attr("data-penyelenggara");
            if(statusPengerjaan == "0"){
                playerHtml = `
                <div class="resource-file">
                    <div class="file-info">
                        <div class="text-center">
                            <img src="/uploads/website-images/test.png" alt="">
                            <h6 class="mt-2">Evaluasi Penyelenggara : ${namaPenyelenggara}</h6>
                            <p>Evaluasi Penyelenggara Diklat, harap diisi dengan jujur dan bijak</p>
                            <p>agar dapat menjadi masukkan dan saran untuk menyelenggarakan diklat dengan lebih baik. </p>
    
                            <a href="#" class="btn btn-primary" id="start-evalpenyelenggara" data-evaltipe="${tipekonten}" data-idkonten="${id_konten}">Beri Penilaian</a>
                        </div>
                    </div>
                </div>`;
            } else {
        ...
        } else if (tipekonten == "evaluasiB") {
            var statusPengerjaan = $(this).attr("data-status");
            var namaPengajar = $(this).attr("data-pengajar");
            if(statusPengerjaan == "0"){
                playerHtml = `
                <div class="resource-file">
                    <div class="file-info">
                        <div class="text-center">
                            <img src="/uploads/website-images/test.png" alt="">
                            <h6 class="mt-2">Evaluasi Pengajar : ${namaPengajar}</h6>
                            <p>Evaluasi Pengajar Diklat, harap diisi dengan jujur dan bijak</p>
                            <p>agar dapat menjadi masukkan dan saran untuk pengajar diklat dalam menyajikan materi. </p>
    
                            <a href="#" class="btn btn-primary" id="start-evalpengajar" data-evaltipe="${tipekonten}" data-idkonten="${id_konten}">Beri Penilaian</a>
                        </div>
                    </div>
                </div>`;
            } else {
    ...
    $(document).on("click", "#start-pretest", function (e) {
        ...
        const tipesoal = $(this).data('tipesoal');
        const matadiklat = $(this).data('matadiklat');
        const id_konten = $(this).data('idkonten');
                                        ...
                                        <div class="file-info">
                                            <div class="text-center">
                                                <div class="test-completion">
                                                    <div class="completion-header">
                                                        <img src="/uploads/website-images/completetest.jpg" alt="Test Image" class="trophy-icon">
                                                        <h2 class="completion-title">Selamat Anda telah menyelesaikan ${headerteks}.</br> Nilai anda sudah tersimpan.</h2>
                                                    </div>
                                            ...
                                            <div class="file-info">
                                                <div class="text-center">
                                                    <div class="test-completion">
                                                        <div class="completion-header">
                                                            <img src="/uploads/website-images/completetest.jpg" alt="Test Image" class="trophy-icon">
                                                            <h2 class="completion-title">Selamat Kamu telah menyelesaikan ${headerteks}.</br> Nilai anda sudah tersimpan.</h2>
                                                        </div>
    ...
    // mulai evaluasi
    $(document).on("click", "#start-evalpenyelenggara", function (e) {

        e.preventDefault();

        const id_konten = $(this).data('idkonten');
        const evaltipe = $(this).data('evaltipe');
        
        // get soal
        $.ajax({
            url: `/peserta/geteval/${evaltipe}/${id_konten}`,
            method: 'GET',
            beforeSend: function () {
                $(".video-payer").html(placeholder);
            },
            success: function (data) {
                        ...
                        <div style="display: flex; flex-direction: column; align-items: center; width: 100%; margin-top: 50px;">
                            <div style="display: flex; justify-content: space-between; width: 100%; align-items: center;">
                                <div style="display: flex; justify-content: center; gap: 10px; flex: 8;">
                                    ...
                                    <div style="text-align: center;">
                                        <label>
                                            <input type="radio" name="q${index}" value="6">
                                        </label>
                                    </div>
                                    <div style="text-align: center;">
                                        <label>
                                            <input type="radio" name="q${index}" value="7">
                                        </label>
                                    </div>
                                    <div style="text-align: center;">
                                        <label>
                                            <input type="radio" name="q${index}" value="8">
                                        </label>
                                    </div>
                                    <div style="text-align: center;">
                                        <label>
                                            <input type="radio" name="q${index}" value="9">
                                        </label>
                                    </div>
                                    <div style="text-align: center;">
                                        <label>
                                            <input type="radio" name="q${index}" value="10">
                                        </label>
                                    </div>
                ...
                $(".end-test-button").on("click", function() {
                    Swal.fire({
                        ...
                        text: 'Apakah anda yakin selesei mengisi evaluasi penyelenggara ? Pastikan penilaian sudah terisi sepenuhnya.',
                        imageUrl: "/uploads/website-images/mark.png",
                        imageWidth: 150,
                        imageHeight: 150,
                        showCancelButton: true,
                        ...
                        if (result.isConfirmed) {
                            ...
                            const answersPayload = answers
                                .map((jawaban, index) => ({
                                    id_core_soal_evaluasi_penyelenggara: data[index].id,
                                    jawaban: jawaban
                                }))

                            $.ajax({
                                url: "/peserta/saveJawabanEvalPenyelenggara",
                                method: "POST",
                                data: JSON.stringify(answersPayload),
                                contentType: "application/json",
                                headers: {
                                            ...
                                            <div class="file-info">
                                                <div class="text-center">
                                                    <div class="test-completion">
                                                        <div class="completion-header">
                                                            <img src="/uploads/website-images/SuccesEval.png" alt="Test Image" class="trophy-icon">
                                                            <h2 class="completion-title">Terimakasih! penilaian evaluasi penyelenggara anda sudah tersimpan</h2>
                                                        </div>
    ...
    $(document).on("click", "#start-evalpengajar", function (e) {
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                $(".end-test-button").on("click", function() {
                    Swal.fire({
                        title: 'Simpan Penilaian',
                        text: 'Apakah anda yakin selesei mengisi evaluasi pengajar ? Pastikan penilaian sudah terisi sepenuhnya.',
                        imageUrl: "/uploads/website-images/mark.png",
                        imageWidth: 150,
                        imageHeight: 150,
                        showCancelButton: true,
                        ...
                        if (result.isConfirmed) {
                            ...
                            const answersPayload = answers
                                .map((jawaban, index) => ({
                                    id_core_soal_evaluasi_pengajar: data[index].id,
                                    jawaban: jawaban
                                }))

                            $.ajax({
                                url: "/peserta/saveJawabanEvalPengajar",
                                method: "POST",
                                data: JSON.stringify(answersPayload),
                                contentType: "application/json",
                                headers: {
                                            ...
                                            <div class="file-info">
                                                <div class="text-center">
                                                    <div class="test-completion">
                                                        <div class="completion-header">
                                                            <img src="/uploads/website-images/SuccesEval.png" alt="Test Image" class="trophy-icon">
                                                            <h2 class="completion-title">Terimakasih! penilaian evaluasi pengajar anda sudah tersimpan</h2>
                                                        </div>
